...
class PiPicoACAnalog(ChannelInterface):
    ...
    def __init__(self, config, hardware_serial_no=None, serial_no=None,channel_stats=None, *args, **kwargs):
        ...
        super().__init__(config=config,hardware_serial_no=self.pipico.serial_no, serial_no=self.serial_no,channel_stats=channel_stats, *args, **kwargs)
