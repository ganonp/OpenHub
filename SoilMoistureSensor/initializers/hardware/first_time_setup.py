import uuid
from SoilMoistureSensor.hardware_interfaces import pi_pico, veml_7700, mod_probe, mcp3008, dht22
from SoilMoistureSensor.initializers.homekit_interfaces.first_time_kit_setup import interface_channel_with_homekit_accessory
import board
