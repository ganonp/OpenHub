...
from SoilMoistureSensor.globals import id_hardware_map, hardware_id_channels_map, id_channels_map, accessories, driver, \
    hub
...
def load_hub_config(hub):
    ...
    response = requests.get('http://192.168.3.132:8000/hubs/' + serial_no)
